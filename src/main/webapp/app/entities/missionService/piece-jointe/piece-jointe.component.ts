...
export class PieceJointeComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.pieceJointeService
      ...
      .subscribe(
        (res: HttpResponse<IPieceJointe[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInPieceJointes(): void {
    this.eventSubscriber = this.eventManager.subscribe('pieceJointeListModification', () => this.loadPage());
  }
