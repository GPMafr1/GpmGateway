...
export class WorkOrderComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.workOrderService
      ...
      .subscribe(
        (res: HttpResponse<IWorkOrder[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  trackId(index: number, item: IWorkOrder): number {
    // eslint-disable-next-line @typescript-eslint/no-unnecessary-type-assertion
    return item.id!;
  }

  registerChangeInWorkOrders(): void {
    this.eventSubscriber = this.eventManager.subscribe('workOrderListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IWorkOrder[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
