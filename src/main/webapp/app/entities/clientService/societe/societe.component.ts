...
export class SocieteComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.societeService
      ...
      .subscribe(
        (res: HttpResponse<ISociete[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInSocietes(): void {
    this.eventSubscriber = this.eventManager.subscribe('societeListModification', () => this.loadPage());
  }
