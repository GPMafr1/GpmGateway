...
export class VehiculeComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.vehiculeService
      ...
      .subscribe(
        (res: HttpResponse<IVehicule[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  protected onSuccess(data: IVehicule[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
