...
import { AffaireComponent } from 'app/entities/affaireService/affaire/affaire.component';
...
describe('Component Tests', () => {
  describe('Affaire Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.affaires && comp.affaires[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
