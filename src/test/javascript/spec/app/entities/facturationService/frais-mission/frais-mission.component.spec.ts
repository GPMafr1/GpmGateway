...
import { FraisMissionComponent } from 'app/entities/facturationService/frais-mission/frais-mission.component';
...
describe('Component Tests', () => {
  describe('FraisMission Management Component', () => {
    let comp: FraisMissionComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(FraisMissionComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.fraisMissions && comp.fraisMissions[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
