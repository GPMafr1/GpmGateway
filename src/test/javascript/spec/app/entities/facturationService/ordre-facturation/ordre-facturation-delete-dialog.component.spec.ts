...
import { OrdreFacturationDeleteDialogComponent } from 'app/entities/facturationService/ordre-facturation/ordre-facturation-delete-dialog.component';
  ...
  describe('OrdreFacturation Management Delete Component', () => {
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        declarations: [OrdreFacturationDeleteDialogComponent],
      })
