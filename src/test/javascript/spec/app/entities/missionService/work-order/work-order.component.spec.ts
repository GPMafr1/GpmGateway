...
import { WorkOrderComponent } from 'app/entities/missionService/work-order/work-order.component';
...
describe('Component Tests', () => {
  describe('WorkOrder Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.workOrders && comp.workOrders[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
