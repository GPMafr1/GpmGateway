...
import { PieceJointeComponent } from 'app/entities/missionService/piece-jointe/piece-jointe.component';
...
describe('Component Tests', () => {
  describe('PieceJointe Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.pieceJointes && comp.pieceJointes[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
